 ...
 *
 * PIC32CZ CA90 Oscillator Control (OSCCTRL) Register Definitions
 *
 * Covers XOSC0/1, DFLL48M, and DPLL0/1. Same IP block as SAMD5E5.
 *
 * CA90-specific note: The Curiosity Ultra board uses a MEMS oscillator,
 * so XTALEN=0 on XOSC0. The DPLL0 is configured with LDR=49
 * (Fin=6 MHz after divider, 6x50=300 MHz).
 *
 ****************************************************************************/
...
#define SAM_OSCCTRL_EVCTRL_OFFSET     0x0000
#define SAM_OSCCTRL_INTENCLR_OFFSET   0x0004
#define SAM_OSCCTRL_INTENSET_OFFSET   0x0008
#define SAM_OSCCTRL_INTFLAG_OFFSET    0x000c
#define SAM_OSCCTRL_STATUS_OFFSET     0x0010
#define SAM_OSCCTRL_XOSCCTRL0_OFFSET  0x0014
#define SAM_OSCCTRL_XOSCCTRL1_OFFSET  0x0018
...
#define SAM_OSCCTRL_XOSCCTRL(n)   (SAM_OSCCTRL_BASE + SAM_OSCCTRL_XOSCCTRL0_OFFSET + (n)*4)
...
#define SAM_OSCCTRL_DPLLCTRLA(n)  (SAM_OSCCTRL_BASE + SAM_OSCCTRL_DPLL0CTRLA_OFFSET + (n)*0x14)
#define SAM_OSCCTRL_DPLLRATIO(n)  (SAM_OSCCTRL_BASE + SAM_OSCCTRL_DPLL0RATIO_OFFSET + (n)*0x14)
#define SAM_OSCCTRL_DPLLCTRLB(n)  (SAM_OSCCTRL_BASE + SAM_OSCCTRL_DPLL0CTRLB_OFFSET + (n)*0x14)
#define SAM_OSCCTRL_DPLLSYNCBUSY(n) (SAM_OSCCTRL_BASE + SAM_OSCCTRL_DPLL0SYNCBUSY_OFFSET + (n)*0x14)
#define SAM_OSCCTRL_DPLLSTATUS(n) (SAM_OSCCTRL_BASE + SAM_OSCCTRL_DPLL0STATUS_OFFSET + (n)*0x14)

/* XOSCCTRL register bit definitions */
