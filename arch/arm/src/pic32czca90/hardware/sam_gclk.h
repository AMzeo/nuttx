 ...
 *
 * PIC32CZ CA90 Generic Clock Controller (GCLK)
 * Base: 0x44050000
 *
 ****************************************************************************/
 ...
 * GENCTRL Bits
 *
 * SRC field values (CA90-specific):
...
/* SERCOM slow clocks — grouped by APB bridge.
...
/* SDMMC — each instance has a main clock and a slow clock channel */
