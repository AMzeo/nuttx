...
/****************************************************************************
 * arch/arm/src/pic32czca90/sam_lowputc.c
 *
 * PIC32CZ CA90 low-level UART output
 ****************************************************************************/
...
sam_usart_configure(const struct sam_usart_config_s * const config)
{
   ...
   * For asynchronous mode, the formula for the baud generation is
   *
...
void sam_usart_reset(const struct sam_usart_config_s * const config)
{
   ...
   * the reset completes, the SERCOM will registers will be restored to their
